...
const Update = ({ setOpenUpdate, user, setCurrentUser }) => {
  ...
  const mutation = useMutation(
    (user) => makeRequest.put("/users", user),
    {
      onSuccess: () => {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("currentUser"); // or cookies/session based on your app
    setCurrentUser(null); // clear user state in context or parent
    ...
    <div className="update">
      <div className="wrapper">
        ...
        <form>
          ...
          <input type="text" name="password" value={texts.password || ""} onChange={handleChange} />
